...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <motion.span className="section-subtitle">Contact Me</motion.span>

      <motion.div className="contact-container container grid">
        <motion.div className="contact-content ">
          <motion.h3 className="contact-title">Talk to me</motion.h3>
          ...
          <motion.div className="contact-info">
            <motion.div className="contact-card">
              ...
              <span className="contact-card-data">xyz@gmail.com</span>

              <a href="xyz@gmail.com" className="contact-button">
                Write Me {""}
                <i className="bx bx-right-arrow-alt contact-button-icon"></i>
              </a>
            </motion.div>
            <motion.div className="contact-card" variants={variants}>
              <i className="bx bxl-whatsapp contact-card-icon"></i>

              <h3 className="contact-card-title">Whatsapp</h3>
              <span className="contact-card-data">+234 123456789</span>

              <a
                href="https://api.whatsapp.com/send? phone=08079916076&text=Hello, more info!"
        ...
        <motion.div className="contact-content" variants={variants}>
          ...
          >
            <motion.div className="contact-form-div">
